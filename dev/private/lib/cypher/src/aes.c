...
// ================================================================================================================================
// JAB
#if defined(LUMI_USE_POLARSSL_AES_ECB)
// JAB
// ================================================================================================================================
...
// ================================================================================================================================
// JAB
#endif  // LUMI_USE_POLARSSL_AES_ECB
// JAB
// ================================================================================================================================
                    ...
                    unsigned int keysize )
{
    switch (keysize)
    {
        case 16:
        case 128:
            return aes_set_key(key, 16, ctx);
            //break;//SANG
        case 24:
        case 192:
            return aes_set_key(key, 24, ctx);
            //break;//SANG
        case 32:
        case 256:
            return aes_set_key(key, 32, ctx);
            //break;//SANG
    }
...
{
    if (mode == AES_DECRYPT)
        return aes_decrypt(input, output, ctx);
    return aes_encrypt(input, output, ctx);
}

#else   // LUMI_USE_POLARSSL_AES_ECB
// JAB
// ================================================================================================================================
...
int aes_self_test( int verbose )
{
    ...
    //aes_context ctx;
    aes_context *ctx = NULL;
    ctx = polarssl_malloc(sizeof(aes_context));
    iv = polarssl_malloc(16);
    buf = polarssl_malloc(64);
    if (!ctx || !buf || !iv)
    {
        if (ctx) polarssl_free(ctx);
        if (buf) polarssl_free(buf);
        if (iv) polarssl_free(iv);
        return 1;
    }
    // SANG
