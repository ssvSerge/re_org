...
// ============================================================================================================================
// SANG
#define POLARSSL_ERR_SHA256_MALLOC_FAILED			   -0x0079  /**< MALLOC failed. */
#define POLARSSL_ERR_SHA256_HMAC_SHORT_KEY             -0x007B  /**< key must be >14 bytes. */
// SANG
// ============================================================================================================================
...
typedef struct
{
    ...
    uint32_t W[64];             /*!< JAB: avoid need to malloc in sha256_process() for Blackfin */
    unsigned char scratch[32];  /*!< JAB: avoid need to malloc in sha256_hmac_starts() for Blackfin */
}
sha256_context;
