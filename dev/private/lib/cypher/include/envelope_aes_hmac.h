...
extern ENVELOPE_EXTERN_C int EnvelopeSeal_aes_hmac(const unsigned char * EKEY, size_t EKEY_len,
...
extern ENVELOPE_EXTERN_C int EnvelopeUnseal_aes_hmac(const unsigned char * EKEY, size_t EKEY_len,
                                                     const unsigned char * MKEY, size_t MKEY_len,
                                                     uint32_t *mid, unsigned char * iv,
                                                     const unsigned char * input,  size_t   input_len,
                                                           unsigned char * output, size_t * output_len,
