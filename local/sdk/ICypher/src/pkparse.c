...
#if defined(POLARSSL_PEM_PARSE_C)
    size_t len;
    /* Even though its small, I don't like this context sitting on the stack */
        
    pem_context* pem = polarssl_malloc(sizeof(pem_context));
    if(pem == NULL) return POLARSSL_ERR_PK_MALLOC_FAILED;
