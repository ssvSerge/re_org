...
struct _V100_ENC_SENSOR_INFO {
    ...
    u64   nVersion;             // [ Zeros(2) FW_REV(2) HW_SEC_ELEMENT_Rev(2) Spoof_Rev(2)]  MSB to LSB
    u8    zeropad[24];
};
...
struct _V100_ENC_VERIFY_RESULT_HDR {
    ...
    u32   nMatchResults;    // A bitmask representing which records matched(LSB right to left,  represents record index 0)
};
