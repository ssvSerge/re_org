...
struct Color
{
   Color(
       unsigned char red,
       unsigned char green,
       unsigned char blue) : mRed(red), mGreen(green), mBlue(blue)
   {
   }
...
public:
   ...
   void setTranspose(bool enable);

   bool CreateColorImage(unsigned char *pImage, unsigned char *pColorImage, int nWidth, int nHeight);
