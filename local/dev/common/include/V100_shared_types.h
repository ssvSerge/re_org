/***************************************************************************************/
// (c)Copyright 2020 HID Global Corporation/ASSA ABLOY AB. ALL RIGHTS RESERVED.
//
...
**        $Id: V100_shared_types.h 39646 2022-02-07 23:28:51Z jeaton $
**        $Rev: 39646 $
**        $Date: 2022-02-07 16:28:51 -0700 (Mon, 07 Feb 2022) $
**        $Author: jeaton $
**
...
**
**        Lumidigm Inc Copyright 2020 All Rights Reserved.
**
******************************************************************************/
#pragma once
...
// Disable unscoped enum warnings introduced in VS2019 to preserve backwards compatibility
#pragma warning(push)
...
#define MAX_FW_DATA_SIZE        (1024*1024*100)
#define MAX_USER_RECORD_SIZE    10240

/******************************************************************************
**
**        C O M M A N D   E N U M E R A T I O N S
**
******************************************************************************/
...
typedef struct {
    ...
    unsigned short
        ...
        Presence_Detect_Available,    // Unused
...
typedef struct
{
    ...
    unsigned short
        ...
        Override_HeartBeat_Display,    // Unused
...
typedef struct
{
    unsigned short
        ...
        COM_Error,
        USB_Error,
        Flash_Updater_Status,
        Struct_Size,
        Latent_Detected,    // Latent detected on last capture (1 if true, 0 if false; V30x-40, V31x, and V42x-NC only)
        Boot_Error,
        /*** RESERVED EXPANSION ***/
        RESERVED_2,
        RESERVED_3,
...
/******************************************************************************
**
**        D E V I C E   D E F I N I T I O N S ,   E N U M S ,   A N D   S T R U C T S
**
******************************************************************************/
...
**
**  Used for communication to and from Lumidigm devices
*/
typedef struct
{
    // USB Specific
...
typedef enum
{
    ...
    MERCURY_M21X            = 10,
    VENUS_V31X_10           = 11,
    VENUS_V32X              = 12,   // V32x, non-secured
    VENUS_V52X              = 13,   // V52x, secured
...
#define LUMI_PID_V32x_EMBEDDED                0x0320
#define LUMI_PID_V52x_EMBEDDED                0x0520


/*
**    Device diagnostics structure
*/
typedef struct
{
    uint
...
/******************************************************************************
**
**        E R R O R   A N D   S T A T U S   C O D E S   A N D   S T R U C T S
**
******************************************************************************/
...
typedef enum
{
    ...
    /* Update Firmware (V52X) */
    ERROR_UPDATE_UNPACK_FAILURE = 0x60,
    ERROR_UPDATE_THREAD_START = 0x61,
    ERROR_UPDATE_EXEC_SCRIPT_FAIL = 0x62,
    ERROR_UPDATE_EXEC_SCRIPT_TIMEOUT = 0x63,
    ERROR_UPDATE_EXEC_NON_ZERO = 0x64,
    ERROR_UPDATE_CFG_INVALID = 0x65,
    ERROR_UPDATE_REMOVE_KEYS_FAILED = 0x66,
    /* NOOP */
    STATUS_NO_OP = 0xFF,
} _V100_OP_ERROR;
...
/*
**  Device operation status structure
*/
typedef struct
{
...
/******************************************************************************
**
**        P A R A M E T E R   E N U M S   A N D   D E F I N I T I O N S
**
******************************************************************************/
...
/*
**  Types of Crop Levels Available
*/
typedef enum
{
    CROP_NONE = 0x00,
    CROP_FUTURE_1 = 0x01,    // Reserved for future use
    CROP_FUTURE_2 = 0x02,    // Reserved for future use
    CROP_272x400 = 0x03,
    CROP_LAST = 0x04,
} _V100_CROP_LEVEL;
...
/*
**    WSQ Compression Ratio Limits
*/
#define MIN_WSQ_COMPRESSION_RATIO 2        // Min WSQ compression ratio user can set
#define MAX_WSQ_COMPRESSION_RATIO 20    // Max WSQ compression ratio user can set


/*
**    Types of Latent Detection Modes Available
*/
typedef enum
{
...
**
**  For M30x and V30x(Firmware> 9538) sensors
*/
typedef enum
{
...
/*
**    Types of Trigger Modes Available
*/
typedef enum
{
    TRIGGER_OFF                = 0x00,
...
/*
**  Types of Vid Stream Modes Available
*/
typedef enum
{
    VID_STREAM_OFF = 0x0,
...
/******************************************************************************
**
**        C A P T U R E ,   I M A G E ,   A N D   T E M P L A T E   T Y P E S
**
******************************************************************************/

/*
**  Types of Captures Available
*/
typedef enum
{
    CAPTURE_IMAGE = 0x00,
    CAPTURE_VERIFY = 0x10,
    CAPTURE_ENROLL_1 = 0x21,
    CAPTURE_ENROLL_2 = 0x22,
    CAPTURE_ENROLL_3 = 0x23,
    CAPTURE_ENROLL_4 = 0x24,
    CAPTURE_ENROLL_5 = 0x25,
    CAPTURE_ENROLL_6 = 0x26,
    CAPTURE_ENROLL_7 = 0x27,
    CAPTURE_ENROLL_8 = 0x28,
    CAPTURE_ENROLL_9 = 0x29,
    CAPTURE_ENROLL_10 = 0x2A,
    CAPTURE_FINGER_LIFT = 0x30,
} _V100_CAPTURE_TYPE;
...
/*
**  Types of Image Formats Available
*/
typedef enum
{
...
/*
**    Types of FIR Record Formats Available
*/
typedef enum
{
...
/******************************************************************************
**
**        C A P T U R E   R E S U L T   D E F I N I T I O N S
**
******************************************************************************/

/*
** Capture Results Structure (No longer used in 1-1 verification)
**
** This struct is used in V100_Capture, V100_Capture_Cb, and V100_Verify to obtain spoof scores
*/
typedef struct
{
...
/******************************************************************************
**
**        I D D B   E N U M S ,   S T R U C T S ,   A N D   F L A G S
**
******************************************************************************/
...
/*
**  Flags for the "nFlags" member of _MX00_ID_PARAMETERS
**  Use V100_ID_Set_Parameters to update the flags used for enrollment, identification, and verification
*/
...
/*
**  Security Levels for the "nSecurityLevel" member of _MX00_ID_PARAMETERS
**  By default, the security level will be set to MEDIUM_SECURITY_LEVEL.
**  Use V100_ID_Set_Parameters to update the security level used for enrollment, identification, and verification
*/
#define LOW_SECURITY_LEVEL                1
#define MEDIUM_SECURITY_LEVEL            2
#define HIGH_SECURITY_LEVEL                3
#define VERY_HIGH_SECURITY_LEVEL        4
#define MAX_SECURITY_LEVEL                4


/*
**  1-N Database Initialization Structure
*/
typedef struct
{
...
/*
**  1-N Database Identification Parameters Structure
*/
typedef struct
{
    uint nSecurityLevel;
...
/*
**  1-N Database Infomation Structure
*/
typedef struct
{
    uint nGroupID;
...
/*
**  1-N Database Metrics Structure
*/
typedef struct
{
    uint nGroupID;
...
/*
**  1-N Database User Record Structure
**
**  Each user record corresponds to a User and Finger
...
/*
**  1-N Database Template Instance Record Structure
*/
typedef struct
{
...
/*
**  1-N Database Identification Results Structure
*/
typedef struct
{
...
/*
**  1-N Database Save Debug Structure
*/
typedef struct
{
...
/******************************************************************************
**
**        B A R C O D E   D E F I N I T I O N S ,   E N U M S ,   A N D   S T R U C T S
**
******************************************************************************/
...
/*
**  Types of QRCode Encode Modes Available
*/
typedef enum
{
    QR_MODE_NONE = 0x00,
...
/*
**  Types of QRCode Error Correction Levels Available
*/
typedef enum {
...
/******************************************************************************
**
**        F I L E S Y S T E M   E N U M S   A N D   S T R U C T S
**
******************************************************************************/
...
/******************************************************************************
**
**        C A L L B A C K   T Y P E S
**
******************************************************************************/

/*
**  _V100_Capture_Cb_Callback
**
**  Callback definition for V100_Capture_Cb
*/
typedef int(*_V100_Capture_Cb_Callback)(_V100_ACQ_STATUS_TYPE Acq_Status);


/******************************************************************************
**
**        S E R I A L   P R O T O C O L   D E F I N I T I O N S
**
******************************************************************************/
...
/******************************************************************************
**
**        C O M M A N D    P A C K E T   D E F I N I T I O N S
**
******************************************************************************/
...
typedef enum
{
    ...
    LOG_TYPE_CRITICAL_ERROR
} _V100_LOG_TYPE;

typedef enum
{
    LOG_OPTION_NONE,
    LOG_OPTION_RETRIEVE,    // dumps log
    LOG_OPTION_RESET,        // clears log (perf log is cleared every capture)
    LOG_OPTION_ENABLE,        // enables log (default is enabled)
    LOG_OPTION_DISABLE        // disables log
} _V100_LOG_OPTION;
