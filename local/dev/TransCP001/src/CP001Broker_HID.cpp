...
bool CP001Broker::cb_CMD_ARM_TRIGGER(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Arm_Trigger");
...
bool CP001Broker::cb_CMD_GET_IMAGE(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Get_Image");
...
bool CP001Broker::cb_CMD_GET_COMPOSITE_IMAGE(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Get_Composite_Image");
    //
    // uchar* pCG = NULL;
    // uint nCGSize = 0;
    //
...
bool CP001Broker::cb_CMD_GET_TEMPLATE(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Get_Template");
    //
...
bool CP001Broker::cb_CMD_SET_OPTION(const std::shared_ptr<ICmd>& pCmd) {
    ...
    //
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Set_Option");
    //
...
bool CP001Broker::cb_CMD_ENC_CLEAR(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Clear");
    //
...
bool CP001Broker::cb_CMD_ENC_GET_SPOOF_SCORE(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Get_Spoof_Score");
    //
...
bool CP001Broker::cb_CMD_ENC_SET_PARAMETERS(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Set_Parameters");
    //
    // CExecStatus status = CMD_EXECUTIVE.Execute_Enc_Set_Parameters( object->GetSK(), object->GetSKSize(), object->GetANSOL(), object->GetANSOLSize(), object->GetCropLevel(), object->GetTimeout());
    //
    // if (CExecStatus::CMD_EXEC_OK != status) {
    //     // normally, we would parse the return code from the command exec
    //     // and translate to an appropriate GEN_ERR_* code.  But the legacy
...
bool CP001Broker::cb_CMD_ENC_GET_RND_NUMBER(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Get_Rnd_Number");
    //
    // // Fill in
    // short nArg = 0;
...
bool CP001Broker::cb_CMD_ENC_GENERATE_SESSIONKEY(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Generate_SessionKey");
    //
...
bool CP001Broker::cb_CMD_ENC_GET_KEY(const std::shared_ptr<ICmd>& pCmd) {
    ...
    //
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Get_Key");
    //
    // short nArg = 0;
    // object->GetArguement(nArg);
...
bool CP001Broker::cb_CMD_ENC_GET_KEYVERSION(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Get_KeyVersion");
    //
...
bool CP001Broker::cb_CMD_ENC_SET_KEY(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Set_Key");
    //
...
bool CP001Broker::cb_CMD_ENC_SET_ACTIVEKEY(const std::shared_ptr<ICmd>& pCmd) {
    ...
    // ISensorInstance::GetInstance()->GetServiceProvider()->GetLogger()->Log_String(SEL_DEBUG, __FILE__, "Atomic_Enc_Set_ActiveKey");
    //
