...
static int sha1_hmac_starts_wrap( void *ctx, const unsigned char *key,
                                   size_t keylen )
{
...
static int sha224_hmac_starts_wrap( void *ctx, const unsigned char *key,
                                     size_t keylen )
{
...
//        unsigned char *output )
static int sha224_hmac_wrap( const unsigned char *key, size_t keylen,
                             const unsigned char *input, size_t ilen,
                             unsigned char *output )
{
...
static int sha256_hmac_starts_wrap( void *ctx, const unsigned char *key,
                                     size_t keylen )
{
...
//        const unsigned char *input, size_t ilen,
//        unsigned char *output )
static int sha256_hmac_wrap( const unsigned char *key, size_t keylen,
                             const unsigned char *input, size_t ilen,
                             unsigned char *output )
{
...
static int sha384_hmac_starts_wrap( void *ctx, const unsigned char *key,
                                     size_t keylen )
{
...
//        const unsigned char *input, size_t ilen,
//        unsigned char *output )
static int sha384_hmac_wrap( const unsigned char *key, size_t keylen,
                             const unsigned char *input, size_t ilen,
                             unsigned char *output )
// JAB
// ================================================================================================================================
...
static int sha512_hmac_starts_wrap( void *ctx, const unsigned char *key,
                                     size_t keylen )
{
    //sha512_hmac_starts( (sha512_context *) ctx, key, keylen, 0 );
    return sha512_hmac_starts( (sha512_context *) ctx, key, keylen, 0 );
}
// JAB
// ================================================================================================================================
...
//        const unsigned char *input, size_t ilen,
//        unsigned char *output )
static int sha512_hmac_wrap( const unsigned char *key, size_t keylen,
                             const unsigned char *input, size_t ilen,
                             unsigned char *output )
{
