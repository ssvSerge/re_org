...
// ============================================================================================================================
#define POLARSSL_ERR_SHA512_MALLOC_FAILED               -0x007B  /**< MALLOC failed. */
#define POLARSSL_ERR_SHA512_HMAC_SHORT_KEY             -0x007D  /**< key must be >14 bytes. */
// ============================================================================================================================
...
typedef struct
{
    ...
    uint64_t W[80];             /*!< JAB: avoid need to malloc in sha512_process() for Blackfin */
    unsigned char scratch[64];  /*!< JAB: avoid need to malloc in sha512_hmac_starts() for Blackfin */
}
sha512_context;
...
/**return         0 if successful, or POLARSSL_ERR_SHA512_MALLOC_FAILED**/
