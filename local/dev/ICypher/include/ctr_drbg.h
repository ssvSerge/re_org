...
// ================================================================================================================================
// JAB
#define POLARSSL_ERR_CTR_DRBG_MALLOC_FAILED                -0x003B  /**< MALLOC failed. */
// JAB
// ================================================================================================================================
...
#define CTR_DRBG_RESEED_INTERVAL    500000   /**< Interval before reseed is performed by default */
#endif
...
typedef struct
{
    ...
    unsigned char key_scratch[CTR_DRBG_KEYSIZE];        /*!< JAB: ctr_drbg_update_internal() */
    unsigned char tmp_scratch[CTR_DRBG_SEEDLEN];        /*!< JAB: ctr_drbg_update_internal() */
    unsigned char add_scratch[CTR_DRBG_SEEDLEN];        /*!< JAB: ctr_drbg_update() */
    unsigned char seed_scratch[CTR_DRBG_MAX_SEED_INPUT];/*!< JAB: ctr_drbg_reseed() */
    unsigned char add1_scratch[CTR_DRBG_SEEDLEN];        /*!< JAB: ctr_drbg_random_with_add() */
    unsigned char tmp1_scratch[CTR_DRBG_BLOCKSIZE];        /*!< JAB: ctr_drbg_random_with_add() */
